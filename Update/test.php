...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
        ...
        <ul class="navbar-nav mr-auto">
           ...
           <!-- Home  -->
            ...
            <!-- Display -->
             <li class="nav-item active">
                 <a class="nav-link" href="../Display/RandomTestDisplay.php"> Display </a>
            </li>
    ...
    <div class="mx-auto order-0">
        <a class="navbar-brand mx-auto" href="RandomTestUpdate.php">Random Test - Update Panel</a>
    </div>
...
<!--  Date picker 
  ...
  <div  class="col">
    ...
    <strong>Round</strong>
        <input type="text" class="form-control" name="round" required="" id="round" value="<?php echo  $_SESSION['round'] ?>" > </input>
              ...
              <!-- ************* -->
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                         <button class="btn btn-primary" type="submit" name="done">Add to Current Event</button>
                      </div>
                    </div>
                  </div>
                </div>
