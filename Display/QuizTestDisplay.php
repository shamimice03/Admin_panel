...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="mx-auto order-0">
        <a class="navbar-brand mx-auto" href="CodingTestUpdate.php">Quiz Test - Current Event Questions</a>
    </div>
...
<!--  Main-->
 <main role="main" class="container" style="margin-top: 30px">
    ...
    <?php
           ...
           $q ="SELECT * FROM `quiz_test_update`"; 
...
<td >
 ...
 <a class="btn btn-secondary btn-sm text-white" style="width: 150px"   href="edit.php?id=<?php echo $res['id']; ?>&event=1" > Edit </a>
 <a class="btn btn-danger btn-sm text-white"  style="width: 150px" href="delete.php?id=<?php echo $res['id']; ?>&event=1"> Delete </a> 
 <a class="btn btn-success btn-sm text-white"  style="width: 150px" href="LibraryMove.php?id=<?php echo $res['id']; ?>&event=1" > Move to archives </a> 
</div>
