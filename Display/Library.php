<?php
  ...
  $table = 'coding_library';
  }
  else if($event==3){
  $table = 'interview_library';
  }
  if($event==4){

  $table = 'random_library';
  }
...
<!--    
           Display 
             <li class="nav-item active">
                 <a class="nav-link" href="../Update/QuizTestUpdate.php"> Add+ </a>
            </li>

             API
             <li class="nav-item active">
                 <a class="nav-link" href="../APIs/QuizTestApi.php"> API </a>
            </li> -->
             ...
             <!-- Heading -->
    <div class="mx-auto order-0 text-center text-white">

        <?php 

          if($event==1){
          ?>
          <a class="navbar-brand mx-auto">Quiz Library</a>
          <?php
          }
          else if($event==2){
          ?>
           <a class="navbar-brand mx-auto">Coding Library</a>
          <?php
          }
          else if($event==3){
          ?>
           <a class="navbar-brand mx-auto">Interview Question Library</a>
          <?php
          }
          if($event==4){
          ?>
          <a class="navbar-brand mx-auto">Random Library</a>
...
<td >
 ...
 <a class="btn btn-danger btn-sm text-white"  style="width: 150px" 
 href="delete_library.php?id=<?php echo $res['id']; ?>&library=<?php echo $event; ?>"  > Delete </a> 

 <a class="btn btn-success btn-sm text-white"  style="width: 150px"
  href="CurrentEventMove.php?id=<?php echo $res['id']; ?>&library=<?php echo $event; ?>"   > Add to current event </a> 
</div>
