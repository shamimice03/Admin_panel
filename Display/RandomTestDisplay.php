...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
        ...
        <ul class="navbar-nav mr-auto">
           ...
           <!-- Home  -->
            ...
            <!-- Display -->
             <li class="nav-item active">
                 <a class="nav-link" href="../Update/RandomTestUpdate.php"> Add+ </a>
            </li>

            <!-- API -->
             <li class="nav-item active">
                 <a class="nav-link" href="../APIs/RandomTestApi.php"> API </a>
            </li>
    ...
    <div class="mx-auto order-0">
        <a class="navbar-brand mx-auto" href="RandomTestUpdate.php">Random Test - Current Event Questions</a>
    </div>
...
<!--  Main-->
 <main role="main" class="container" style="margin-top: 30px">
    ...
    <?php
           ...
           $q ="SELECT * FROM `random_test_update`"; 
...
<td >
 ...
 <a class="btn btn-secondary btn-sm text-white" style="width: 150px"   href="edit.php?id=<?php echo $res['id']; ?>&event=4" > Edit </a>
 <a class="btn btn-danger btn-sm text-white"  style="width: 150px" href="delete.php?id=<?php echo $res['id']; ?>&event=4"> Delete </a> 
 <a class="btn btn-success btn-sm text-white"  style="width: 150px" href="LibraryMove.php?id=<?php echo $res['id']; ?>&event=4" > Move to archives </a> 
</div>
